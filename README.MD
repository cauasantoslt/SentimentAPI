...
| **Nginx** | Opicional | Proxy Reverso utilizado para servir o Frontend |
| **PostgreSQL** | Opicional | Banco de dados para persistência de dados |
| **Flyway** | Opicional | Gerenciamento de migrações de banco de dados |
